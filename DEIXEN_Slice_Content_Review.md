...
| `ui.assessment.carryover` | changed — 07 D39 | Before the assessment started, this session already had — entries: {N}, hints: {H}. They stay visible and are included in this result. | <span dir="rtl">قبل بدء التقييم كان في هذه الجلسة — عدد الإدخالات: {N}، عدد التلميحات: {H}. تبقى ظاهرة وهي محسوبة ضمن هذه النتيجة.</span> |
